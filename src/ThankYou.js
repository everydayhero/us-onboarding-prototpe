  ...
  return (
    <div className="ThankYou">
      <div className="ThankYou__content">
        ...
        <p>Because we're serious about compliance, we'll verify your details before finalising your application and activating your everydayhero account. This process takes 3 - 5 business days.</p>
        ...
        <p className="ThankYou__team">&mdash; The team at everydayhero</p>
      </div>
    </div>
  )
}
